...
When i try resolve this issue, i wanna know when my s8 restarted, so i code a widget with uebersicht, the widget call a shell script, the shell request a api coded on nodejs running on S8
